    ...
    <div class="p-4">
        <nav class="space-y-1">
            <a href="/profile/dashboard.php"
                class="flex items-center space-x-3 p-3 rounded-lg sidebar-link <?= isActivePage('dashboard.php') ? 'active' : '' ?>">
            ...
            <a href="/profile/edit.php"
                class="flex items-center space-x-3 p-3 rounded-lg sidebar-link <?= isActivePage('edit.php') ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <a href="/profile/edit_password.php"
                class="flex items-center space-x-3 p-3 rounded-lg sidebar-link <?= isActivePage('edit_password.php') ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-5 h-5 text-gray-500">
                    <path stroke-linecap="round" stroke-linejoin="round"
